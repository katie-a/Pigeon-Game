...
sleepTimeButton = rectButton('Go to sleep', 400, 410, 209, 60, fontsize = 27)
sleepShopButton = rectButton('Upgrade your nest', 400, 410, 209, 60, fontsize = 27)
...
class careLevel(rectButton):
    ...
    def drawShop(self):
        ...
        pygame.draw.rect(win, (255, 255, 255), (875, 27, 75, 30))
        win.blit(coin, (878, 32))
        pygame.draw.rect(win, (0,0,230), (875, 27, 75, 30), 3)
        drawMoney(905,35,27)
...
sleepButton = careLevel('Sleep', 347, 320, 280, 60, 1000.0, pygame.image.load("sleepShop.png"))
