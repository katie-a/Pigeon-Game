...
checkIt = po.checkIt
homescreen = po.homescreen
maingame = po.maingame
loseLevel = po.loseLevel
money = po.money
sleepScreen = po.sleepScreen
totalComfort = po.totalComfort
...
#rectangular buttons
playButton = po.rectButton('Play!',400, 350, 209, 60)
instButton = po.rectButton('Instructions', 400, 420, 209, 60)
sleepTimeButton = po.rectButton('Go to sleep', 400, 435, 209, 60, fontsize = 27)
sleepShopButton = po.rectButton('Upgrade your nest', 400, 435, 209, 60, fontsize = 27)


#care level buttons
hungerButton = po.careLevel('Hunger', 37, 320, 280, 60, random.uniform(1000.0, 1010.0), pygame.image.load("foodShop.png"))
hygieneButton = po.careLevel('Hygiene', 37, 395, 280, 60, 1000.0, pygame.image.load("hygieneScreen.png"))
sleepButton = po.careLevel('Sleep', 347, 320, 280, 60, 1000.0, pygame.image.load("sleepShop1.png"))

rb = po.rectButton
drawSelf = rb.drawSelf()
drawText = rb.drawText()
checkSelf = rb.checkSelf()

cb = po.careLevel
loseLevel = cb.loseLevel()
drawLevel = cb.drawLevel()
checkShop = cb.checkShop()
drawShop = cb.drawShop()
mainGameCheck = cb.mainGameCheck()
...
#exit buttons
foodExit = po.exitButton()
instExit = po.exitButton()
mainExit = po.exitButton()
hygieneExit = po.exitButton()
sleepShopExit = po.exitButton()
sleepTimeExit = po.exitButton()
